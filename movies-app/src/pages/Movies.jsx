...
const Movies = () => {
    ...
    const getMovies = async (title) => {
        try {
            ...
            const { data } = await axios.get('http://www.omdbapi.com/?apikey=f52b8a86&s=' + title);
                    ...
                    <div className="col-6">
                        <form action="">
                            <div className="input-group">
                                <span className="input-group-text fw-bold bg-white text-black">Search Movies</span>
                                <input
                                    type="text"
            ...
            <div className="row">
                {movies ?
                    movies.map((movie) => (
                        ...
                        <Link key={movie.imdbID} to={`/description/${movie.imdbID}`}
                            className="col-md-4 my-3 text-decoration-none">
                            <div className="card">
                                <div className="card-header">
                                    <img className="card-img-top" src={movie.Poster === 'N/A' ? '/movie_na.png' : movie.Poster} alt="img_movie" />
                                </div>
                                <div className="card-body">
                                    <h5 className="card-title text-center fw-bold text-white">{movie.Title}</h5>
